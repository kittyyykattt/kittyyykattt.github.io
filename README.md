...
<img src="https://capsule-render.vercel.app/api?type=soft&color=fcd0da&height=120&section=header&text=Katya%20Serechenko&fontSize=42&fontColor=560738&animation=fadeIn&fontAlignY=65" />
...
- [Network Connectivity](https://github.com/kittyyykattt/AS_Connectivity) — Autonomous system network analysis
- [Hash Table Spell Checker](https://github.com/kittyyykattt/Hash-Table-Spell-Checker) — Fast spell checking via hash tables
- [Self Organizing BST](https://github.com/kittyyykattt/Self-Organizing-Binary-Search-Tree) — Adaptive binary search tree implementation
- [Queue Flight Route Search](https://github.com/kittyyykattt/Queue-ADT-Flight-Route-Search-BFS) — BFS-based flight route finder
- [Vector & Matrix Template Library](https://github.com/kittyyykattt/Vector-Matrix-Template-Library) — C++ template library
- [Calculator](https://github.com/kittyyykattt/Calculator-Java-Application) — Java desktop calculator
- [Battleship](https://github.com/kittyyykattt/HWX) — Java battleship game
